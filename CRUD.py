...
while input_choice != 'exit':
    ...
    if input_choice == '2' :
        ...
        print(cursor.execute("SELECT * from Animal;"))
        print()
        print(cursor.execute("SELECT * from Race;"))
        print()        
        print(cursor.execute("SELECT * from Espace;"))
