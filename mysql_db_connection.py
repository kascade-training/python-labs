...
def main (): 
    ...
    if db1 == "oui":
       ...
       # cursor.execute("CREATE DATABASE IF NOT EXISTS %s", (nomdb,))
        ...
        cursor.execute("CREATE TABLE IF NOT EXISTS Race (id smallint(6) unsigned NOT NULL AUTO_INCREMENT, nom varchar(40) NOT NULL, espece_id smallint(6) unsigned NOT NULL, description text, PRIMARY KEY (id)) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1")
        cursor.execute("""INSERT INTO Race VALUES 
        ...
        cursor.execute("""INSERT INTO Espece VALUES 
